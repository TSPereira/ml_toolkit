...
from ..clustering.clustering_estimators import WeightedEstimator, silhouette_score_block
from ..clustering.plot_functions import plot_metrics
...
# todo restructure whole file
#  remove Kprototypes
#  Metrics are computed after training
#  Save outputs of training to DataFrame with specific names. if names exist calculate relevant metrics
#  Additional file for explainability
#  Remove feature encoders. Data has to enter already encoded. Add test for types of each column
#  make clustering a class which will inherit from selected class
#      def create_class(base_cls):
#           class something(base_cls):
#           return something
...
class BaseCluster(object):
    ...
    # todo generalize for array or dataframe (if dataframe, extract index and columns. if array give f_# names to
    #  columns and index =range)
