...
class DummyLR(_LRScheduler):
    ...
    def get_lr(self):
        # todo activate for pytorch >= 1.4.0
...
class OneCycleLR(_LRScheduler):
    ...
    def __init__(self,
        ...
        if version.parse(torch.__version__) >= version.parse('1.4.0'):
            warnings.warn('OneCycleLR was introduced in torch package on version 1.4.0. Change to torch version.',
