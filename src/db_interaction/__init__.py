...
try:
    ...
    print(import_error_msg.format('PostgreSQLManager', 'support_toolkit.src.db_interaction.postgres', e.name))

try:
    from .oracle import OracleManager
except ModuleNotFoundError as e:
    print(import_error_msg.format('OracleManager', 'support_toolkit.src.db_interaction.postgres', e.name))
